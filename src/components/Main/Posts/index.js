  ...
  return (
    <section>
      <div className='post-div'>
        <h2 className='post-h2'>{languages[defaultLanguageItem]?.contents.for_you}</h2>
        <div className='posts'>
          <article className='post'>
            ...
            <p className='post-para'>{languages[defaultLanguageItem]?.contents.post_para}</p>
            <span className='post-price'>USD 130</span>
            <button className='post-button'>{languages[defaultLanguageItem]?.contents.post_button}</button>
          </article>
          <article className='post'>
            <img className='img-posts' src={HomeImg}></img>
            <div className='post-title'>
        ...
        <h2 className='post-h2'>{languages[defaultLanguageItem]?.contents.your_favorites}</h2>
        <div className='posts'>
          <article className='post'>
            <img className='img-posts' src={HomeImg}></img>
            <div className='post-title'>
        ...
        <h2 className='post-h2'>{languages[defaultLanguageItem]?.contents.most_views}</h2>
        <div className='posts'>
          <article className='post'>
            <img className='img-posts' src={HomeImg}></img>
            <div className='post-title'>

                    ...
                    <div>
                      <div className="post-stars">
                        ...
                        <svg className="star" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <defs>
                            <clipPath id="clip0_1232_50">
                              <rect width="20" height="20" fill="white" />
                            </clipPath>
                            <clipPath id="clip1_1232_50">
                              <rect width="11" height="20" fill="white" />
                            </clipPath>
                          </defs>
                        </svg>
                        <span className="point-starts">4.5 (423)</span>
                      </div>
                    </div>
                    <p className="post-para" >
                      {value.post_para.substring(0, 65)}...
                    </p>
